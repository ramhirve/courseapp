...
//           <Link to={'/courses'} className='hover:bg-orange-500 border px-4 py-3 rounded w-full text-center'>Corses</Link>
//         </div>
//       </header>
...
function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-black to-blue-950 flex flex-col items-center justify-center px-4 py-10">
      {/* Header */}
      <header className="w-full max-w-4xl flex items-center justify-between p-5 bg-gradient-to-r from-black to-blue-950 shadow-lg rounded-lg mb-6">
        <div className="flex items-center space-x-2">
          <img src={logo} alt="logo" className="h-10 w-10 rounded-full" />
          <Link to="/" className="text-xl font-bold text-orange-500">
            CourseHaven
        ...
        <div className="flex gap-3">
          <Link to="/login" className="py-2 px-4 border border-gray-500 rounded-md">
            Login
          </Link>
          <Link to="/courses" className="hover:bg-orange-500 border border-gray-500 px-4 py-2 rounded-md text-white">
            Courses
          </Link>
        </div>
      </header>
