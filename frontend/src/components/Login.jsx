    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-black to-blue-950 text-white">
      ...
      <header className="w-full flex justify-between items-center px-5 py-3 bg-gradient-to-r from-black to-blue-950">
        ...
        <div className="flex items-center space-x-4">
          <Link to={'/signup'} className="py-2 px-4 border border-gray-500 rounded-md">Signup</Link>
          <Link to={'/admin/signup'} className="hover:bg-orange-500 border border-gray-500 px-4 py-2 rounded-md text-white">Admin</Link>
        </div>
      </header>
